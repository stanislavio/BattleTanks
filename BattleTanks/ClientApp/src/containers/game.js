...
class GameWrapper extends Component{
    ...
    render(){
      ...
      const content = players.isSuccess & map.isSuccess ? <Game rebuild_user={() => this.props.rebuild_user(this.props.user.id)} setPlayers={() => {if(this.props.game.players.data.length < 2) this.props.set_players(this.props.match.params.gameId)}} setFirstPlayer={this.setFirstPlayer} setSecondPlayer={this.setSecondPlayer} gameId={this.props.match.params.gameId} hub={this.props.hubConnection} game={this.props.game} current_user={this.props.user} /> : null;
