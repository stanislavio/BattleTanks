...
class FindGameWrapper extends Component{
    ...
    render(){
      ...
      const content = isSuccess && this.props.tanks.isSuccess ? <FindGame user={this.props.user} info={this.props.infoStatus} joinToGame={this.props.join_to_game} tanks={this.props.tanks.data} data={data} /> : null;  
